...
public class TC_09_MyInformationPageTest extends BaseTest
{
	...
	@Test(priority = 31 , dataProviderClass = Utilities.class, dataProvider = "dp")
	...
	@Test(priority = 41 , dataProviderClass = Utilities.class, dataProvider = "dp")
	...
	@Test(priority = 48, dataProviderClass = Utilities.class, dataProvider = "dp")
