...
//			
			...
			// Filter out 'GED' and 'HiSet'
			for (WebElement option : options11) {
			    String optionText = option.getText();
			    if (!optionText.equalsIgnoreCase("GED") && !optionText.equalsIgnoreCase("HiSet")) {
			...
			if (!filteredOptions.isEmpty()) {
			    Random random111 = new Random();
			    int randomIndex111 = random111.nextInt(filteredOptions.size());
			    WebElement randomOption11 = filteredOptions.get(randomIndex111);
			    Thread.sleep(1000);
			    randomOption11.click();
			} else {
			...
			String 	selectedHighSchoolTextforRecentSchool	=	getDriver().findElement(By.xpath("//div[@id='school_highschool']")).getText();
			log.debug("Selected High school City: " + selectedHighSchoolTextforRecentSchool);
			System.out.println("Selected High school City: " + selectedHighSchoolTextforRecentSchool);
	...
	public void Random_CollegeUniversities(String colKey,String colValue) throws EncryptedDocumentException, Exception
	{
		...
		if(selectedOption.contains("attended/attending college"))
		{
			...
			if(selectedOption1.contains("Y"))
			{
				...
				initializeWriteExcelSheets(System.getProperty("user.dir")+ "//src//src//test//resources//com//ugapp//excel//testdata.xlsx");
				setExcelData(colKey,colValue,"validData", 103, "Transfer credits to ASU", "Yes");
				saveReport(System.getProperty("user.dir") + "//src//src//test//resources//com//ugapp//excel//testdata.xlsx");
			...
			if(selectedOption1.contains("N"))
			{
				...
				log.debug("Selected option:  " + PreviousCollegeEligibility.get());
				initializeWriteExcelSheets(System.getProperty("user.dir")+ "//src//src//test//resources//com//ugapp//excel//testdata.xlsx");
				setExcelData(colKey,colValue,"validData", 103, "Transfer credits to ASU", "No");
				saveReport(System.getProperty("user.dir") + "//src//src//test//resources//com//ugapp//excel//testdata.xlsx");
